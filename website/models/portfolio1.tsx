...
export const listOfProperties = [
    ...
    { name: 'Rolls-Royce', imgPath: '/propertyImgs/rollsroyce.jpg', location: 'Newport Beach, CA', value: 180000, description: 'The SUV, modeled on the latest innovations in the tech industry instantly draw your attention. The supercooled engine is quicker than any electric car. Jessica has spared no expense.' },
    ...
    { name: 'Mysterious Laboratory', imgPath: '/propertyImgs/mysteriousLab.jpg', location: 'Brasov, Romania', value: 1500000, description: 'What could this possibly be for?' },
    { name: 'Sacred Texts', imgPath: '/propertyImgs/sacredTexts.jpg', location: 'New York, NY', value: 1500000, description: 'Limited edition copies of the Bhagavad Gita, Torah, Bible, Quran, books of wiccan witchcraft and philosophers stone' },
    { name: 'Copyrights and Patents', imgPath: '/propertyImgs/patent.jpg', location: 'Stanford, CA', value: 1500000, description: ' Jessica is a genius, that is one thing that no one can deny' },
];
