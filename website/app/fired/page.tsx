...
export default function FiredNarrative() {
    ...
    const [gameStory, setGameStory] = useState([
        `Once again, Y has paid more taxes than he originally would have, sans your involvement. 
        Enough is enough. Only slightly regretfully, he tells you that you are fired.`,
        `You know it was your poor performance that led to this result. But you think of the endless
        zeros in Y's accounts, and your parents, who have worked tirelessly for over thirty five years 
        and will never see a fraction of that money.`,
        `Finally, you think back to that faithful day, when Y offered you the job, and all the potential
