...
export default function FiredNarrative() {
    ...
    const [gameStory, setGameStory] = useState([
        `Elizabeth had to pay more taxes than she originally would have, sans your involvement. 
        One strike is enough. Only slightly regretfully, she tells you that you are fired.`,
